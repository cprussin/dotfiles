...
(use-package org-agenda
  ...
  (setq org-agenda-window-setup 'only-window
        ...
        org-agenda-custom-commands '(("A" "All Tasks" tags-todo "-BLOCKED" ((org-agenda-tag-filter-preset '("-pyth"))))
                                     ("a" "Agenda" ((agenda "" ((org-agenda-skip-function '(org-agenda-skip-entry-if 'todo '("BLOCKED")))
                                      ...
                                      ((org-agenda-tag-filter-preset '("-pyth"))))
                                     ("b" "Blocked Tasks" todo "BLOCKED" ((org-agenda-tag-filter-preset '("-pyth"))))
                                     ("r" "Recurring Tasks" tags-todo "SCHEDULED={.+\\+.+}/!-BLOCKED|DEADLINE={.+\\+.+}/!-BLOCKED" ((org-agenda-tag-filter-preset '("-pyth"))))
                                     ("s" "Scheduled Tasks" tags-todo "SCHEDULED={^[^\\+]+$}/!-BLOCKED|DEADLINE={^[^\\+]+$}/!-BLOCKED" ((org-agenda-tag-filter-preset '("-pyth"))))
                                     ("u" "Unscheduled Tasks" tags-todo "-SCHEDULED={.+}-DEADLINE={.+}/!-BLOCKED" ((org-agenda-tag-filter-preset '("-pyth"))))

                                     ("p" . "Pyth")
                                     ("pA" "All Tasks" tags-todo "-BLOCKED" ((org-agenda-tag-filter-preset '("+pyth"))))
                                     ("pa" "Agenda" ((agenda "" ((org-agenda-skip-function '(org-agenda-skip-entry-if 'todo '("BLOCKED")))
                                                                 (org-agenda-overriding-header "Agenda")))
                                                     (todo "BLOCKED" ((org-agenda-overriding-header "Blocked Tasks")))
                                                     (tags-todo "PRIORITY=\"A\"-SCHEDULED={.+}-DEADLINE={.+}/!-BLOCKED" ((org-agenda-overriding-header "On Deck")))
                                                     (tags-todo "-PRIORITY=\"A\"-SCHEDULED={.+}-DEADLINE={.+}/!-BLOCKED" ((org-agenda-overriding-header "Backlog"))))
                                      ((org-agenda-tag-filter-preset '("+pyth"))))
                                     ("pb" "Blocked Tasks" todo "BLOCKED" ((org-agenda-tag-filter-preset '("+pyth"))))
                                     ("pr" "Recurring Tasks" tags-todo "SCHEDULED={.+\\+.+}/!-BLOCKED|DEADLINE={.+\\+.+}/!-BLOCKED" ((org-agenda-tag-filter-preset '("+pyth"))))
                                     ("ps" "Scheduled Tasks" tags-todo "SCHEDULED={^[^\\+]+$}/!-BLOCKED|DEADLINE={^[^\\+]+$}/!-BLOCKED" ((org-agenda-tag-filter-preset '("+pyth"))))
                                     ("pu" "Unscheduled Tasks" tags-todo "-SCHEDULED={.+}-DEADLINE={.+}/!-BLOCKED" ((org-agenda-tag-filter-preset '("+pyth"))))))
  :general
