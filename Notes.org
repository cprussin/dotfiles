...
- [ ] Ensure wireguard & home-assistant correctly restarts on clean reboot (looks like key services aren't actually awaiting key dependencies)
- [ ] Lock down wireguard to it's own subnet and map in / proxy interfaces for coredns & home-assistant-proxy
- [ ] Fix dns
  - [ ] Better wireguard domain
  - [ ] Better wireguard dns
  - [ ] Add local network dns for crux & wireguard
- [ ] Modularize
** TODO Move everything to wayland
** TODO Fix emacs performance issues
** TODO Fix slow wifi reconnects
** TODO Ensure reboots work properly for crux
** TODO Complete wireguard migration
